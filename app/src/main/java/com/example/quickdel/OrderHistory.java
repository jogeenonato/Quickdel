...
public class OrderHistory extends AppCompatActivity implements OrderAdapter.OnNoteListener {
    ImageView back_btn;
...
//            }
    ...
    public void onNoteclick(int position) {
        String data = String.valueOf(list.get(position).getOrderNumber());
        Toast.makeText(OrderHistory.this, data, Toast.LENGTH_SHORT).show();
    }
}